...
4. LightWeight - Benchmarking suggests that Akka model can handle 2.5 million actors per gigabyte of heap memory and can process 50 million messages per second on a single machine.
